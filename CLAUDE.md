...
Verification: `scripts/run-coverage.sh unit` → **193 passed, 0 failed, 0 skipped** (`TestResults/Coverage/2026.07.28_19-41-38-unit.xcresult`); Release build succeeded; installed on the physical iPhone. Not yet exercised on device.
