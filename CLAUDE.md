...
- `xBill/DesignSystem/Components/XBillTabBar.swift` — canonical premium bottom tab bar with near-black rounded container, purple selected state, muted inverse unselected state, and 44pt tap targets.
