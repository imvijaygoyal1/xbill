...
- `xBill/DesignSystem/Components/XBillDashboardPrimitives.swift` — reusable dashboard primitives: `XBillSectionHeader`, `XBillMetricCard`, and `XBillStatusChip`; used by Home and intended for other metric/action dashboards.
