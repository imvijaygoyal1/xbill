...
begin
  ...
  values
    ('eeeeeeee-0001-0001-0001-000000000001', review_group_id, reviewer_id, 18.00, 'Flights to Tokyo', 'transport', 'USD', 'Reviewer paid; equal split.', null, 'none', now() - interval '5 days'),
    ('eeeeeeee-0002-0002-0002-000000000002', review_group_id, alice_id, 9.00, 'Hotel - Night 1', 'accommodation', 'USD', 'Alice paid; reviewer owes a share.', null, 'none', now() - interval '4 days'),
    ('eeeeeeee-0003-0003-0003-000000000003', review_group_id, reviewer_id, 12.00, 'Sushi dinner', 'food', 'USD', 'Reviewer paid; custom split.', null, 'none', now() - interval '3 days'),
    ('eeeeeeee-0004-0004-0004-000000000004', review_group_id, bob_id, 6.00, 'Day trip to Nikko', 'transport', 'USD', 'Bob paid; reviewer owes a share.', null, 'none', now() - interval '2 days'),
    ('eeeeeeee-0005-0005-0005-000000000005', review_group_id, reviewer_id, 4.50, 'Convenience store run', 'shopping', 'USD', 'Recent activity sample.', null, 'none', now() - interval '1 day')
  on conflict (id) do update
  ...
  values
    ('eeeeeeee-0001-0001-0001-000000000001', reviewer_id, 6.00, true, now() - interval '5 days'),
    ('eeeeeeee-0001-0001-0001-000000000001', alice_id, 6.00, false, null),
    ('eeeeeeee-0001-0001-0001-000000000001', bob_id, 6.00, false, null),
    ('eeeeeeee-0002-0002-0002-000000000002', reviewer_id, 3.00, false, null),
    ('eeeeeeee-0002-0002-0002-000000000002', alice_id, 3.00, true, now() - interval '4 days'),
    ('eeeeeeee-0002-0002-0002-000000000002', bob_id, 3.00, false, null),
    ('eeeeeeee-0003-0003-0003-000000000003', reviewer_id, 5.00, true, now() - interval '3 days'),
    ('eeeeeeee-0003-0003-0003-000000000003', alice_id, 4.00, false, null),
    ('eeeeeeee-0003-0003-0003-000000000003', bob_id, 3.00, false, null),
    ('eeeeeeee-0004-0004-0004-000000000004', reviewer_id, 2.00, false, null),
    ('eeeeeeee-0004-0004-0004-000000000004', alice_id, 2.00, false, null),
    ('eeeeeeee-0004-0004-0004-000000000004', bob_id, 2.00, true, now() - interval '2 days'),
    ('eeeeeeee-0005-0005-0005-000000000005', reviewer_id, 1.50, true, now() - interval '1 day'),
    ('eeeeeeee-0005-0005-0005-000000000005', alice_id, 1.50, false, null),
    ('eeeeeeee-0005-0005-0005-000000000005', bob_id, 1.50, false, null)
  ...
  values ('ffffffff-ffff-ffff-ffff-ffffffffffff', reviewer_id, reviewer_id, alice_id, 2.50, 'USD', 'Concert tickets', false)
  on conflict (id) do update
